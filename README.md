...
> 📌 定时任务默认每 10 秒轮询一次，同步混剪结果和 AI 文案生成结果。
...
3. **AI 加持** - 企业级 AI 视频生产能力，自动剪辑、转场、配乐
...
| `admin/app/common/service/ProducevideoService.php` | 混剪 API           |
